...
export default async function getLatestLanding(): Promise<Product[]> {
    await new Promise((resolve) => setTimeout(resolve, 4000)); // wait 1 second
    return latestFromUs;
}
